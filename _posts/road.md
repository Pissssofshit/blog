...
- [ ] 垃圾回收
    - [ ] 三色标记
        ...
        结合Go内存分析工具一起看
- [x] 对象池/内存池
    最好在Golang中找些实际例子，比如fmt.Println
...
### **P0** 性能优化
- [ ] [节约千台容器，Go程序性能瓶颈实战分析](https://zhuanlan.zhihu.com/p/490652454)
### 网络编程
- [ ] 网络编程
    - [ ] socket编程
        - [ ] 超时处理
...
- [ ] 负载均衡
    - [X] 算法
    - [ ] 数据分片
    - [ ] [28 | 案例：如何在 Go 微服务中实现负载均衡？](https://kaiwu.lagou.com/course/courseInfo.htm?courseId=287#/detail/pc?id=3823)
- [ ] 持续集成
### 资料
